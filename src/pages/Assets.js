...
const Assets = () => {
  ...
  // Map of asset.id (or fallback key) -> full asset object
  ...
  return (
    <Page active="assets.html">
      ...
      <main className="opencost-main-content">
        {/* KPI DASHBOARD SECTION - Pure Carbon Grid */}
